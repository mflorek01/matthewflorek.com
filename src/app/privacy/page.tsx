...
export default function PrivacyPage() {
  return (
    <main>
      ...
      <p>If anonymous analytics is enabled, the site may collect page and tab views, project and link interactions, resume-download counts, approximate referrer and campaign information, broad device/browser information, and coarse geographic information such as country, region, or city. The detailed session view is restricted to the site owner’s private admin area.</p>
      ...
      <p>Analytics retention is currently a manual policy, not an automated deletion process. The operator must review Umami at least quarterly and record the review; the target is to remove raw records older than approximately 12 months and aggregate reporting older than approximately 24 months when the configured Umami controls support that distinction. Until each review is completed, retention may be longer.</p>
